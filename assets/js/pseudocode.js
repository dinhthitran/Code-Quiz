...
// The answers and the questions will be accessible in that object.
...
//on click function that checks if the answer is correct
  ...
  // If the answer is incorrect decrement 10 seconds from the countdown then move to the next question
